...
void generateValues(int n) {
    static float value = 100.00;   // static variable
    int i;
...
// Function to calculate age (pass by reference)
...
int main() {
    ...
    // Call function with address of structure
    calculateAge(&p);
...
int main() {
    ...
    // Assign value to integer member
    d.i = 65;
    ...
    printf("Character value = %c\n", ptr->i);  // same memory interpreted as char
